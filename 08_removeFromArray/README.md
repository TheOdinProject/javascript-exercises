...
- you can manipulate the original array you pass into the function call or create a new array, but in both cases your function must return the resulting array.
